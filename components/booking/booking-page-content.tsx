...
// Fixing the type errors by ensuring the motion.div properties are correctly typed
...
export default function BookingPageContent() {
  ...
  useEffect(() => {
    ...
    setServiceSlug(searchParams.get("service"));
  }, []);
    ...
    <Suspense fallback={<div>Loading...</div>}>
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <motion.div {...motionDivProps} className="text-center mb-12">
