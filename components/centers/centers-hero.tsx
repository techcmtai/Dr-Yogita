  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image
          src="/centers/centers-hero-bg.png"
          alt="Our Physiotherapy Centers"
          fill
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Find Dr. Yogita's physiotherapy centers near you. Multiple locations across Gurgaon and Delhi NCR with
            specialized care for all your needs.
          </motion.p>
